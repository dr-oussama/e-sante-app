...
import 'package:hepius/toxicite/digestive/diarrhees/q4.dart';



class Dq3 extends StatefulWidget {
  String rep1='';
  String rep2='';

  Dq3(this.rep1,this.rep2);

  @override
  State<Dq3> createState() => _Dq3State(rep1,rep2);
}

class _Dq3State extends State<Dq3> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';

  _Dq3State(this.rep1,this.rep2);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Dq4(rep1,rep2,rep3)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش كاتحسي بالالم في البطن ديالك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/digestive/pain.png',height: 250,),
                ],
              ),
              Padding(
