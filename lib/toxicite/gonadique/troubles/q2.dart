...
import 'package:hepius/toxicite/gonadique/troubles/q3.dart';



class Trq2 extends StatefulWidget {
  String rep1='';

  Trq2(this.rep1);

  @override
  State<Trq2> createState() => _Trq2State(rep1);
}

class _Trq2State extends State<Trq2> {
  int selected = 0;
  String rep1='';
  String rep2='';

  _Trq2State(this.rep1);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Trq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك الحكة في المهبل؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/itch.png',height: 250,),
                ],
              ),
              Padding(
