...
import 'package:hepius/toxicite/gonadique/troubles/q4.dart';



class Trq3 extends StatefulWidget {
  String rep1='';
  String rep2='';

  Trq3(this.rep1,this.rep2);

  @override
  State<Trq3> createState() => _Trq3State(rep1,rep2);
}

class _Trq3State extends State<Trq3> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';

  _Trq3State(this.rep1,this.rep2);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Trq4(rep1,rep2,rep3)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك إفرازات أو نزيف مهبلي بزاف؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/pubi.png',height: 250,),
                ],
              ),
              Padding(
