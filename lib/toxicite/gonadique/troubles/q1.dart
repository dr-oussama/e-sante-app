...
import 'package:hepius/toxicite/gonadique/troubles/q2.dart';



class Trq1 extends StatefulWidget {
  const Trq1({Key? key}) : super(key: key);

  @override
  State<Trq1> createState() => _Trq1State();
}

class _Trq1State extends State<Trq1> {
  int selected = 0;
  String rep1='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Trq2(rep1)),
          );
          setState(() {
            selected = index;
          });
