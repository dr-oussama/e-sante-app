...
import 'package:hepius/toxicite/gonadique/cycle/q3.dart';



class Cyq2 extends StatefulWidget {
  String rep1='';

  Cyq2(this.rep1);

  @override
  State<Cyq2> createState() => _Cyq2State(rep1);
}

class _Cyq2State extends State<Cyq2> {
  int selected = 0;
  String rep1='';
  String rep2='';

  _Cyq2State(this.rep1);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Cyq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك انقطاع في الدورة الشهرية؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/stop.png',height: 250,),
                ],
              ),
              Padding(
