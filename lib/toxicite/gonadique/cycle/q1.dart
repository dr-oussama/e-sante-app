...
import 'package:hepius/toxicite/gonadique/cycle/q2.dart';



class Cyq1 extends StatefulWidget {
  const Cyq1({Key? key}) : super(key: key);

  @override
  State<Cyq1> createState() => _Cyq1State();
}

class _Cyq1State extends State<Cyq1> {
  int selected = 0;
  String rep1='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Cyq2(rep1)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش الدورة الشهرية منتظمة؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/period.png',height: 250,),
                ],
              ),
              Padding(
