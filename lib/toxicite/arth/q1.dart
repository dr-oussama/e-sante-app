...
import 'package:hepius/toxicite/arth/q2.dart';



class Thq1 extends StatefulWidget {
  const Thq1({Key? key}) : super(key: key);

  @override
  State<Thq1> createState() => _Thq1State();
}

class _Thq1State extends State<Thq1> {
  int selected = 0;
  String rep1='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Thq2(rep1)),
          );
          setState(() {
            selected = index;
          });
