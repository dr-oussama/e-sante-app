...
import 'package:hepius/toxicite/arth/q4.dart';



class Thq3 extends StatefulWidget {
  String rep1='';
  String rep2='';

  Thq3(this.rep1,this.rep2);

  @override
  State<Thq3> createState() => _Thq3State(rep1,rep2);
}

class _Thq3State extends State<Thq3> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';

  _Thq3State(this.rep1,this.rep2);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Thq4(rep1,rep2,rep3)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('كتحسي بالالم في كتافك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/shoulders.png',height: 250,),
                ],
              ),
              Padding(
