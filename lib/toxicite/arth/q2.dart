...
import 'package:hepius/toxicite/arth/q3.dart';



class Thq2 extends StatefulWidget {
  String rep1='';

  Thq2(this.rep1);

  @override
  State<Thq2> createState() => _Thq2State(rep1);
}

class _Thq2State extends State<Thq2> {
  int selected = 0;
  String rep1='';
  String rep2='';

  _Thq2State(this.rep1);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Thq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('كتحسي بالالم في الوركين؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/hips.png',height: 250,),
                ],
              ),
              Padding(
