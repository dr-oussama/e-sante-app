...
import 'package:hepius/toxicite/oculaire/q3.dart';



class Ocq2 extends StatefulWidget {
  String rep1='';

  Ocq2(this.rep1);

  @override
  State<Ocq2> createState() => _Ocq2State(rep1);
}

class _Ocq2State extends State<Ocq2> {
  int selected = 0;
  String rep1='';
  String rep2='';

  _Ocq2State(this.rep1);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Ocq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('عندك احمرار في عينيك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/redness.png',height: 250,),
                ],
              ),
              Padding(
