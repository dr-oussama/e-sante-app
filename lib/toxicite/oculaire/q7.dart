...
import '../digestive/constipation/urgence.dart';
import 'package:http/http.dart' as http;



class Ocq7 extends StatefulWidget {
  String rep1='';
  String rep2='';
  String rep3='';
  String rep4='';
  ...
  Ocq7(this.rep1,this.rep2,this.rep3,this.rep4,this.rep5,this.rep6);

  @override
  State<Ocq7> createState() => _Ocq7State(rep1,rep2,rep3,rep4,rep5,rep6);
}

class _Ocq7State extends State<Ocq7> {
  ...
  _Ocq7State(this.rep1,this.rep2,this.rep3,this.rep4,this.rep5,this.rep6);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          rep7 = text;
          insertData();
          if(rep7 == 'اكثر من 37' || rep6 == 'نعم')
          {
            NotifApi.insertNotifm('oculaire');
            Navigator.push(
              context,
