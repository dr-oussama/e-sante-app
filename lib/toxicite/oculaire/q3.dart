...
import 'package:hepius/toxicite/oculaire/q4.dart';



class Ocq3 extends StatefulWidget {
  String rep1='';
  String rep2='';

  Ocq3(this.rep1,this.rep2);

  @override
  State<Ocq3> createState() => _Ocq3State(rep1,rep2);
}

class _Ocq3State extends State<Ocq3> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';

  _Ocq3State(this.rep1,this.rep2);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Ocq4(rep1,rep2,rep3)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عينيك كيدمعو؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/tear.png',height: 250,),
                ],
              ),
              Padding(
