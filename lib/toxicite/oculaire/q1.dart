...
import 'package:hepius/toxicite/oculaire/q2.dart';



class Ocq1 extends StatefulWidget {
  const Ocq1({Key? key}) : super(key: key);

  @override
  State<Ocq1> createState() => _Ocq1State();
}

class _Ocq1State extends State<Ocq1> {
  int selected = 0;
  String rep1='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Ocq2(rep1)),
          );
          setState(() {
            selected = index;
          });
