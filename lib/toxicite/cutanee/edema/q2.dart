...
class Eq2 extends StatefulWidget {
  ...
  @override
  State<Eq2> createState() => _Eq2State(rep1);
}
...
class _Eq2State extends State<Eq2> {
  ...
  Future<void> insertData()async {
    http.post(Uri.parse("http://192.168.43.231/hepius/toxicite/edema.php"), body: {
      "q1": rep1,
      "q2": rep2,
      "ip":patient.IP,
    });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش تزاد في وزنك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/gain.png',height: 250,),
                ],
              ),
              Padding(
