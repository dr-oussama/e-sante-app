...
import 'package:hepius/toxicite/cutanee/hand/q4.dart';
...
class Hq3 extends StatefulWidget {
  ...
  Hq3(this.rep1,this.rep2);

  @override
  State<Hq3> createState() => _Hq3State(rep1,rep2);
}
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Hq4(rep1,rep2,rep3)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك تقرحات؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/laceration.png',height: 250,),
                ],
              ),
              Padding(
