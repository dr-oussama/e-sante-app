...
import 'package:hepius/toxicite/cutanee/hand/q6.dart';
...
class Hq5 extends StatefulWidget {
  ...
  Hq5(this.rep1,this.rep2,this.rep3,this.rep4);

  @override
  State<Hq5> createState() => _Hq5State(rep1,rep2,rep3,rep4);
}
...
class _Hq5State extends State<Hq5> {
  ...
  _Hq5State(this.rep1,this.rep2,this.rep3,this.rep4);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Hq6(rep1,rep2,rep3,rep4,rep5)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك انتفاخ؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/incr.png',height: 250,),
                ],
              ),
              Padding(
