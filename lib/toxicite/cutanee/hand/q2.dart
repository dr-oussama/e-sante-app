...
import 'package:hepius/toxicite/cutanee/hand/q3.dart';
...
class Hq2 extends StatefulWidget {
  ...
  @override
  State<Hq2> createState() => _Hq2State(rep1);
}
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Hq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('كتحسي بضعف حاسة اللمس؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/touch.png',height: 250,),
                ],
              ),
              Padding(
