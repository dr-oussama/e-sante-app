...
import 'package:hepius/toxicite/cutanee/ongles/q4.dart';



class Oq3 extends StatefulWidget {
  String rep1='';
  String rep2='';

  Oq3(this.rep1,this.rep2);

  @override
  State<Oq3> createState() => _Oq3State(rep1,rep2);
}

class _Oq3State extends State<Oq3> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';

  _Oq3State(this.rep1,this.rep2);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Oq4(rep1,rep2,rep3)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('عندك الالم في صباعك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/paino.png',height: 250,),
                ],
              ),
              Padding(
