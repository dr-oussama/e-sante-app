...
import 'package:hepius/toxicite/cutanee/ongles/q3.dart';



class Oq2 extends StatefulWidget {
  String rep1='';

  Oq2(this.rep1);

  @override
  State<Oq2> createState() => _Oq2State(rep1);
}

class _Oq2State extends State<Oq2> {
  int selected = 0;
  String rep1='';
  String rep2='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Oq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('عندك التهاب في صباعك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/infl.png',height: 250,),
                ],
              ),
              Padding(
