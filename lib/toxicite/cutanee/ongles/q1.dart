...
import 'package:hepius/toxicite/cutanee/ongles/q2.dart';



class Oq1 extends StatefulWidget {
  const Oq1({Key? key}) : super(key: key);

  @override
  State<Oq1> createState() => _Oq1State();
}

class _Oq1State extends State<Oq1> {
  int selected = 0;
  String rep1='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Oq2(rep1)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('عندك تقيح في صباعك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/purulente.png',height: 250,),
                ],
              ),
              Padding(
