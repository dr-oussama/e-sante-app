...
import 'package:hepius/toxicite/cutanee/extravasation/q2.dart';



class Exq1 extends StatefulWidget {
  const Exq1({Key? key}) : super(key: key);

  @override
  State<Exq1> createState() => _Exq1State();
}

class _Exq1State extends State<Exq1> {
  int selected = 0;
  String rep1='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Exq2(rep1)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك شي اعراض من هادو؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/cut.png',height: 250,),
                ],
              ),
              Padding(
