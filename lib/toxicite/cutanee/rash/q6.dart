...
import 'package:hepius/toxicite/cutanee/rash/q7.dart';



class Rq6 extends StatefulWidget {
  String rep1='';
  String rep2='';
  String rep3='';
  String rep5='';

  Rq6(this.rep1,this.rep2,this.rep3,this.rep5);

  @override
  State<Rq6> createState() => _Rq6State(rep1,rep2,rep3,rep5);
}

class _Rq6State extends State<Rq6> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';
  ...
  _Rq6State(this.rep1,this.rep2,this.rep3,this.rep5);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Rq7(rep1,rep2,rep3,rep5,rep6)),
          );
          setState(() {
            selected = index;
          });
