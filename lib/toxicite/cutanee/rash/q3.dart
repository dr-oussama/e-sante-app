...
import 'package:hepius/toxicite/cutanee/rash/q5.dart';



class Rq3 extends StatefulWidget {
  String rep1='';
  String rep2='';

  Rq3(this.rep1,this.rep2);

  @override
  State<Rq3> createState() => _Rq3State(rep1,rep2);
}

class _Rq3State extends State<Rq3> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';

  _Rq3State(this.rep1,this.rep2);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Rq5(rep1,rep2,rep3)),
          );
          setState(() {
            selected = index;
          });
          ...
          child: Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/skinp.png',height: 250,),
                ],
              ),
              Padding(
