...
import 'package:hepius/toxicite/cutanee/rash/q3.dart';



class Rq2 extends StatefulWidget {
  String rep1='';

  Rq2(this.rep1);

  @override
  State<Rq2> createState() => _Rq2State(rep1);
}

class _Rq2State extends State<Rq2> {
  int selected = 0;
  String rep1='';
  String rep2='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Rq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش كتحسي بالحكة؟', style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/haka.png',
                    height: 250,),
                ],
              ),
              Padding(
