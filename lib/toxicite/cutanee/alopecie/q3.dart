...
class Aq3 extends StatefulWidget {
  String rep1='';
  String rep2='';

  Aq3(this.rep1,this.rep2);

  @override
  State<Aq3> createState() => _Aq3State(rep1,rep2);
}

class _Aq3State extends State<Aq3> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';
  ...
  _Aq3State(this.rep1,this.rep2);

  Future<void> insertData()async {
    http.post(Uri.parse("http://192.168.43.231/hepius/toxicite/alopecie.php"), body: {
      "q1": rep1,
      "q2": rep2,
      "q3": rep3,
      "ip":patient.IP,
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك تساقط الشعر في رموشك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/eyelashes.png',height: 250,),
                ],
              ),
              Padding(
