...
import 'package:hepius/toxicite/cutanee/alopecie/q3.dart';



class Aq2 extends StatefulWidget {
  String rep1='';

  Aq2(this.rep1);

  @override
  State<Aq2> createState() => _Aq2State(rep1);
}

class _Aq2State extends State<Aq2> {
  int selected = 0;
  String rep1='';
  String rep2='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Aq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش عندك تساقط الشعر في حجبانك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/types/cutane/eyebrow.png',height: 250,),
                ],
              ),
              Padding(
