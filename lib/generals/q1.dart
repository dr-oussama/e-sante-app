...
import 'package:hepius/generals/q2.dart';



class Gq1 extends StatefulWidget {
  const Gq1({Key? key}) : super(key: key);

  @override
  State<Gq1> createState() => _Gq1State();
}

class _Gq1State extends State<Gq1> {
  int selected = 0;
  String rep1='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Gq2(rep1)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش كتقدي براسك؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/girl-power.png',height: 250,),
                ],
              ),
              Padding(
