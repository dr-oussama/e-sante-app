...
import 'package:hepius/generals/q6.dart';



class Gq5 extends StatefulWidget {
  String rep1='';
  String rep2='';
  String rep3='';
  String rep4='';

  Gq5(this.rep1,this.rep2,this.rep3,this.rep4,);

  @override
  State<Gq5> createState() => _Gq5State(rep1,rep2,rep3,rep4,);
}

class _Gq5State extends State<Gq5> {
  int selected = 0;
  String rep1='';
  String rep2='';
  String rep3='';
  ...
  _Gq5State(this.rep1,this.rep2,this.rep3,this.rep4);
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Gq6(rep1,rep2,rep3,rep4,rep5)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش كتقدري ديري الانشطة اليومية ديالك؟',style: TextStyle(fontSize: 20),),
