...
import 'package:hepius/generals/q3.dart';



class Gq2 extends StatefulWidget {
  String rep1='';

  Gq2(this.rep1);

  @override
  State<Gq2> createState() => _Gq2State(rep1);
}

class _Gq2State extends State<Gq2> {
  int selected = 0;
  String rep1='';
  String rep2='';
    ...
    return SizedBox(
      ...
      child: FlatButton(
        onPressed: (){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Gq3(rep1,rep2)),
          );
          setState(() {
            selected = index;
          });
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('واش كتحسي بالعيا؟',style: TextStyle(fontSize: 20),),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset('assets/images/sigh.png',height: 250,),
                ],
              ),
              Padding(
